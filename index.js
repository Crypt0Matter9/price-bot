...
const uniswapFactoryContract = new Contract(UNISWAP_FACTORY_ABI, UNISWAP_FACTORY_ADDRESS)
...
const kyberRateContract = new Contract(KYBER_RATE_ABI, KYBER_RATE_ADDRESS)
...
async function checkPair(args) {
  ...
  const exchangeContract = new Contract(UNISWAP_EXCHANGE_ABI, exchangeAddress)
